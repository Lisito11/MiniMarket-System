...
public class FormDetalleVenta extends javax.swing.JFrame {
	...
	String[] columnNames = {"ID del Producto", "Hora de la venta", "Cantidad"};
        ...
        btn_finalizarVenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_finalizarVentaActionPerformed(evt);
            }
        });
	...
	jTable1.addMouseListener(new java.awt.event.MouseAdapter() {
	 ...
	 int fila = jTable1.getSelectedRow();
            if (fila >= 0) {
                ...
                String hora = JOptionPane.showInputDialog("Introduzca la nueva fecha", horaE);
