 ...
 * @author Lisito
 */
public class AgregarFactura_Credito extends javax.swing.JDialog {
    ...
    public AgregarFactura_Credito(JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public AgregarFactura_Credito() {
    }
                ...
                if (isNumeric(input_idcompra.getText())) {
                    ...
                    if (proveedor != null && !proveedor.equals("Proveedores")) {
                        ...
                        if (compra.Agregar()) {
                            ...
                            setVisible(false);
                            DetalleFactura_Credito df = new DetalleFactura_Credito(new AgregarFactura_Credito(), true);
                            df.setVisible(true);
                        } else {
